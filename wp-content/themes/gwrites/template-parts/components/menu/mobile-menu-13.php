<ul class="header__menu-mobile-ul">
    ...
    <?php } ?>
    <li class="header__menu-mobile-li">
        <a class="header__menu-mobile-a" href="#Progress">Arbeitsfolge</a>
    </li>
    <li class="header__menu-mobile-li">
        <a class="header__menu-mobile-a" href="#About">Warum wir</a>
    </li>
    <li class="header__menu-mobile-li">
        <a class="header__menu-mobile-a" href="#Garantien">Garantien</a>
    </li>
    <!-- <li class="header__menu-mobile-li">
        <a class="header__menu-mobile-a" href="#Rabbate">Rabbate</a>
    </li> -->
    <!-- <li class="header__menu-mobile-li">
