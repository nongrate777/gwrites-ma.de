            ...
            <form class="estimate _white js-form" onsubmit="ym(<?= \DE\Helpers::getIdYM(); ?>, 'reachGoal', 'fullform'); return true;">
                ...
                <div class="form-row">
                    <div class="form-col _size_4 _size_md_6">
                        ...
                        <div class="_size_auto _size_50">
                            <div class="form-checkbox">
                                <div class="form-checkbox__title">Zusätzliche Leistungen:</div>
                                <div>
                                    <input class="form-checkbox__input"
                                           id="main-form-prasentation"
                                           name="Leistungen[]"
                                           value="Prasentation"
                                           type="checkbox"
                                    />
                                    <label for="main-form-prasentation">Präsentation</label>
                                </div>
                                <div>
                                    <input class="form-checkbox__input"
                                ...
                                <div>
                                    <input class="form-checkbox__input"
                                           ...
                                           type="checkbox"
                                    />
                                    <label for="main-form-expose">Exposé</label>
                                </div>
                            </div>
                    ...
                    <div class="form-col _size_2 _size_md_6">
                        ...
                        <div class="form-input _pb_xxs">
                            <label class="form-input__label_sm" for="main-form-whatsapp">Telefon/WhatsApp</label>
                            <input class="form-input__input"
